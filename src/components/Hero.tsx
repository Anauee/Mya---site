        ...
        <div className="hero-content">
          ...
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <a href="https://wa.me/554196635378?text=Ol%C3%A1!%20Gostaria%20de%20testar%20a%20Mya%20gratuitamente." target="_blank" rel="noopener noreferrer" className="btn-primary">Começar teste gratuito</a>
            </div>
          </div>

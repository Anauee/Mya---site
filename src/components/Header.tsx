      ...
      <nav className="nav-container" ref={navRef}>
        ...
        <div className="nav-content" ref={navContentRef}>
          ...
          <div className="nav-controls">
            ...
            <a href="https://wa.me/5511964435210?text=Ol%C3%A1!%20Gostaria%20de%20testar%20a%20Mya%20gratuitamente." target="_blank" rel="noopener noreferrer" className="cta-btn" ref={ctaRef}>
